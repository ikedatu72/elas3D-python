    ...
    for k in range(1, nz+1):
        for j in range(1, ny+1):
            for i in range(1, nx+1):
                ...
                for n3 in range(3):
                    for n8 in range(8):
                        s11=s11+es[0,n8,n3]*uu[n8,n3]
                        s22=s22+es[1,n8,n3]*uu[n8,n3]
                        s33=s33+es[2,n8,n3]*uu[n8,n3]
                        s13=s13+es[3,n8,n3]*uu[n8,n3]
                        s23=s23+es[4,n8,n3]*uu[n8,n3]
                        s12=s12+es[5,n8,n3]*uu[n8,n3]
                        for n in range(6):
                            str11=str11+cmod[pix[m],0,n]*es[n,n8,n3]*uu[n8,n3]
                            str22=str22+cmod[pix[m],1,n]*es[n,n8,n3]*uu[n8,n3]
                            str33=str33+cmod[pix[m],2,n]*es[n,n8,n3]*uu[n8,n3]
                            str13=str13+cmod[pix[m],3,n]*es[n,n8,n3]*uu[n8,n3]
                            str23=str23+cmod[pix[m],4,n]*es[n,n8,n3]*uu[n8,n3]
                            str12=str12+cmod[pix[m],5,n]*es[n,n8,n3]*uu[n8,n3]
